...
### Constructors
```C++
[[nodiscard]] constexpr StaticVector() noexcept;
[[nodiscard]] constexpr StaticVector(const StaticVector<T, CAPACITY>& rhs) noexcept;
[[nodiscard]] constexpr StaticVector(StaticVector<T, CAPACITY>&& rhs) noexcept;
[[nodiscard]] constexpr StaticVector(std::initializer_list<T> init_list) noexcept;
...
#### operator==
```C++
[[nodiscard]] constexpr auto operator==(const StaticVector& rhs) const noexcept -> bool;
```
