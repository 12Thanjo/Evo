...
namespace evo{
	...
	static_assert(sizeof(i32) == 4, "Expected i32 (signed long) to be 4 bytes - ./engine/src/defines.h");
	...
	static_assert(sizeof(ui32) == 4, "Expected ui32 (unsigned long) to be 4 bytes - ./engine/src/defines.h");
